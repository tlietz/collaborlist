defmodule GoogleCerts.HTTPProcessor.HTTPoisonProcessorTest do
  ...
  test "get_header/2 returns an error if header cannot be found" do
    assert_raise(
      ...
      fn ->
        get_header(@example_res, "Does-Not-Exist")
      end
    )
  end
